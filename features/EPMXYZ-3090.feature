Feature: Verify Advisor is able to select Source account and Underlying investments

  Scenario: Verify investments grid displays correct assets
    ...
    And leave then in disabled state
